...
public class ProductEnquiryBean {
	...
	public String toString() {
		return String.format(
				"ProductEnquiryBean [id=%s, productName=%s, productPrice=%s, productAvailability=%s, discountOffer=%s, unit=%s, totalPrice=%s, port=%s]",
				id, productName, productPrice, productAvailability, discountOffer, unit, totalPrice, port);
	}
